...
<div id="crm-recently-viewed" class="block-civicrm crm-container">
		<a id="crm-recently-viewed-link" class="button" href="#"><span><div class="icon dropdown-icon"></div>{ts}Recente items{/ts}</span></a>
		<div id="crm-recently-viewed-list">
			<div class="crm-recently-viewed-list-inner">
				<ul>
...
{literal}
	<script>
		cj('body').click(function() {
			cj('#crm-recently-viewed-list').hide();
		});

		cj('#crm-recently-viewed-list').click(function(event){
			event.stopPropagation();
		});

		cj('#crm-recently-viewed-link').click(function(event) {
			cj('#crm-recently-viewed-list').toggle();
			event.stopPropagation();
			return false;
		});
